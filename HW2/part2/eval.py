...
from myModels import myResnet, myLeNet, mypretrain
...
def main():
    ...
    parser.add_argument('--path', help='model_path', type=str, default='./save_dir/mypretrain/best_model.pt')
