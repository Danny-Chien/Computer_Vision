...
if __name__ == '__main__':
    ...
    # H1 = solve_homography(x, corners1)
    # H2 = solve_homography(x, corners2)
    H1 = solve_homography(corners1, ref_corns)
    H2 = solve_homography(corners2, ref_corns) 

    output3_1 = warping(secret1, dst, H= H1, ymin=0, ymax= h, xmin= 0, xmax= w, direction= 'b')
    output3_2 = warping(secret2, dst, H= H2, ymin=0, ymax= h, xmin= 0, xmax= w, direction= 'b')
